...
const NAV_ITEMS = [
  ...
  { href: '/news', labelEn: 'NEWS', labelJa: 'ニュース' },
  { href: '/business', labelEn: 'BUSINESS', labelJa: '事業内容' },
  { href: '/about', labelEn: 'ABOUT', labelJa: '企業情報' },
  { href: '/ceo-message', labelEn: 'CEO', labelJa: '代表者メッセージ' },
  { href: '/recruit', labelEn: 'RECRUIT', labelJa: '採用情報' },
  { href: '/wage', labelEn: 'WAGE', labelJa: '工賃・キャリア' },
    ...
    <div>
      ...
      <nav className={cx(styles.nav, isOpen && styles.open)}>
        ...
        <div className={styles.mobileFooter}>
          <a href="https://x.com/woomemorys?s=21" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="https://www.instagram.com/nextgame.ltd" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
